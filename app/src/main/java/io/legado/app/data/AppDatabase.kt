...
import io.legado.app.data.dao.BookGroupOrderDao
import io.legado.app.data.dao.BookSourceDao
import io.legado.app.data.dao.BookTagDao
import io.legado.app.data.dao.BookTagRefDao
...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        BookTag::class, BookTagRef::class, BookGroupOrder::class],
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val bookGroupOrderDao: BookGroupOrderDao
    ...
    abstract val bookTagRefDao: BookTagRefDao
