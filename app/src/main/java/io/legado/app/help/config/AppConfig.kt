...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    var effectiveReplaceFull: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.effectiveReplaceFull, true)
        set(value) {
            appCtx.putPrefBoolean(PreferKey.effectiveReplaceFull, value)
        }
    ...
    fun getBookSortByGroupId(groupId: Long): Int {
        val sort = appDb.bookGroupDao.getByID(groupId)?.getRealBookSort()
            ?: bookshelfSort
