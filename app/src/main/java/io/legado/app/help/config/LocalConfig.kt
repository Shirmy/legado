...
by appCtx.getSharedPreferences("local", Context.MODE_PRIVATE) {
    ...
    var defaultBookGroupId: Long
        get() = getLong("defaultBookGroupId", 0)
        set(value) {
            putLong("defaultBookGroupId", value)
        }

    var bookInfoMarkGroupId: Long
        get() = getLong("bookInfoMarkGroupId", defaultBookGroupId)
        set(value) {
            putLong("bookInfoMarkGroupId", value)
        }
