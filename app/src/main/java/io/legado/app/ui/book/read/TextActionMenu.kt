...
class TextActionMenu(private val context: Context, private val callBack: CallBack) :
    ...
    init {
        ...
        val primaryIds = listOf(R.id.menu_replace, R.id.menu_copy, R.id.menu_search_content)
        menuItems = allMenuItems
        primaryIds.mapNotNullTo(visibleMenuItems) { id ->
            allMenuItems.firstOrNull { it.itemId == id }
        }
        moreMenuItems.addAll(allMenuItems.filterNot { item ->
            primaryIds.contains(item.itemId)
        })
